...
import { ReadDetailsView } from 'src/sections/product/view';

// ----------------------------------------------------------------------

export const metadata = { title: `Read details | Dashboard - ${CONFIG.site.name}` };
...
export default async function Page({ params }: Props) {
  ...
  return <ReadDetailsView read={read} />;
}
